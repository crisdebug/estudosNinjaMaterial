...
(function ($) {
  ...
  $container.append(
    '<h5>Customizar Estudos.Ninja</h5><hr class="mb-2"/>'
    + '<h6>Cores de Barra de navegação</h6>'
  )
  ...
  $checkbox_container.append('<span>Borda na Barra</span>')
  ...
  $container.append('<h6>Cores de Barra lateral Escura</h6>')
  ...
  $container.append('<h6>Cores de Barra lateral Clara</h6>')
  var $sidebar_variants = $('<div />', {
    'class': 'd-flex'
  })
  $container.append($sidebar_variants)
  ...
  $container.append('<h6>Cores de Logo</h6>')
