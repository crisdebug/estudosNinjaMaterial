"""
Django settings for estudosNinja project.
...
SECRET_KEY = 'k(=xcw(zn@&f()p#+&@35481wnrzcclv=4%*u@k=&&7q@9q^y='
...
ROOT_URLCONF = 'estudosNinja.urls'
...
WSGI_APPLICATION = 'estudosNinja.wsgi.application'
